...
test('creating, using and revoking a customer api key with dev bypass', async ({ page }) => {
  console.log(`[TEST] Starting test: creating, using and revoking a customer api key with dev bypass`)
  ...
  console.log(`[TEST] Step 1: Logging in with dev bypass`)
  await loginPage.loginWithDevBypass()
  console.log(`[TEST] Step 1: Login with dev bypass complete`)
  ...
  console.log(`[TEST] Test completed successfully: creating, using and revoking a customer api key with dev bypass`)
})
